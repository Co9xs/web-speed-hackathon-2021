      ...
      <form className="flex flex-col items-center w-full" onSubmit={handleSubmit}>
        ...
        <p className="flex items-center justify-evenly mt-4 w-full text-gray-900">
          <AttachFileInputButton
            ...
            icon={<FontAwesomeIcon iconType="images" styleType="icon" />}
            onChange={handleChangeImages}
          />
          <AttachFileInputButton
            accept="audio/*"
            active={params.sound !== undefined}
            icon={<FontAwesomeIcon iconType="music" styleType="icon" />}
            onChange={handleChangeSound}
          />
          <AttachFileInputButton
            accept="video/*"
            active={params.movie !== undefined}
            icon={<FontAwesomeIcon iconType="video" styleType="icon" />}
